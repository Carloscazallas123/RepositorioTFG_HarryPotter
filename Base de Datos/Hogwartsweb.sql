...
CREATE TABLE USUARIO(
    ...
    CONSTRAINT FK_ID_COMENTARIO FOREIGN KEY (ID_COMENTARIO) REFERENCES COMENTARIO(ID_COMENTARIO)
...
CREATE TABLE COMPRA(
    ...
    CONSTRAINT FK_COMPRA_OBJETO FOREIGN KEY (ID_OBJETO) REFERENCES OBJETO(ID_OBJETO)
);
